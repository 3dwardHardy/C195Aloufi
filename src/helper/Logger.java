...
public class Logger {
    ...
    public static void loginAttempts(String userName, String password) {
        ...
        try {
            ...
            if (trackLogins) {
                String loginSuccess = "Username: " + userName + " had a successful login at: " + LocalDateTime.now() + "\n";
                writer.write(loginSuccess);
            } else {
                String loginFailed = "Username: " + userName + " attempted to login at: " + LocalDateTime.now() + " but was unsuccessful." + "\n";
